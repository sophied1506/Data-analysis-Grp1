...
CHANGE THE INTRO SENTENCE TO EXPLAIN DOING FULL MODEL FIRST
...
INTERPRETING THE MODEL AND SEEING THIS VISUALLY IN @fig-odds
```{r}
#| echo: false
#| warning: false
#| message: false
...
```
@fig-odds tells us ..................... (FOCUS ON AGE AND EMPLOYMENT AS MOST SIGNIFICANT?)



CHECKING THE MODEL WITH AIC AND @fig-stepmodroc.

MAYBE CUT OR REWORD TO FOCUS ON THE REDUCED MODEL AND INTERPRETING THIS:
The reduced model has an AIC of 17009.35 compared to the full model which has an AIC of 17011.99. This demonstrates that although the reduced model has a lower AIC, the difference is negligible. 
...
roc_curve(pred_results,
  ...
  autoplot()
```
@fig-stepmodroc demonstrates that 
